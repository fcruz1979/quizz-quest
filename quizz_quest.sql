...
UPDATE perguntas SET tipo = (
    CASE
	   WHEN pergunta LIKE '%oceano%' THEN 'Mundo'
       WHEN pergunta LIKE '%país mais populoso%' THEN 'Mundo'
       WHEN pergunta LIKE '%capital do Brasil%' THEN 'Mundo'
       WHEN pergunta LIKE '%sistema de governo%' THEN 'Sociedade'
       WHEN pergunta LIKE '%monarquia%' THEN 'Sociedade'
       WHEN pergunta LIKE '%livro%' THEN 'Mundo'
       WHEN pergunta LIKE '%instrumento musical%' THEN 'Mundo'
       WHEN pergunta LIKE '%puberdade%' THEN 'Ciência e Tecnologia'
       WHEN pergunta LIKE '%esporte dos reis%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%esporte mais popular nos Estados Unidos%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%nasceu o esporte conhecido como judô%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%unidade básica da vida%' THEN 'Ciência e Tecnologia'
       WHEN pergunta LIKE '%pai da computação%' THEN 'Ciência e Tecnologia'
       WHEN pergunta LIKE '%fórmula química da água%' THEN 'Ciência e Tecnologia'
       WHEN pergunta LIKE '%pintou a Mona Lisa%' THEN 'Arte e Entretenimento'
       WHEN pergunta LIKE '%protagonista da série de livros "Harry Potter"%' THEN 'Arte e Entretenimento'
       WHEN pergunta LIKE '%cachorro mais famoso da internet%' THEN 'Mundo'
       WHEN pergunta LIKE '%autor da famosa série de livros "Crepúsculo"%' THEN 'Arte e Entretenimento'
       WHEN pergunta LIKE '%maior deserto do mundo%' THEN 'Mundo'
       WHEN pergunta LIKE '%rio mais longo do mundo%' THEN 'Mundo'
       WHEN pergunta LIKE '%nome da fronteira natural entre Estados Unidos e México%' THEN 'Mundo'
       WHEN pergunta LIKE '%documento de identificação mais comum no mundo%' THEN 'Mundo'
       WHEN pergunta LIKE '%primeiro presidente dos Estados Unidos%' THEN 'Sociedade'
       WHEN pergunta LIKE '%nome dado à primeira guerra mundial%' THEN 'Sociedade'
       WHEN pergunta LIKE '%esporte que utiliza uma bola pequena chamada de shuttlecock%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%maior jogador de basquete de todos os tempos%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%esporte nacional do Japão%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%nome dado à primeira missão tripulada a pisar na Lua%' THEN 'Ciência e Tecnologia'
       WHEN pergunta LIKE '%planeta mais próximo do Sol%' THEN 'Ciência e Tecnologia'
       WHEN pergunta LIKE '%pai da eletricidade%' THEN 'Ciência e Tecnologia'
       WHEN pergunta LIKE '%quadro famoso de Leonardo da Vinci que retrata uma mulher com um sorriso enigmático%' THEN 'Arte e Entretenimento'
       WHEN pergunta LIKE '%peça de teatro "Romeu e Julieta"%' THEN 'Arte e Entretenimento'
       WHEN pergunta LIKE '%série de TV que retrata a vida de um professor que começa a fabricar metanfetamina%' THEN 'Arte e Entretenimento'
       WHEN pergunta LIKE '%famosa rua de comércio e entretenimento em Nova York, conhecida como "a cidade que nunca dorme"%' THEN 'Mundo'
       WHEN pergunta LIKE '%nome do animal símbolo do WWF (World Wide Fund for Nature)%' THEN 'Ciência e Tecnologia'
       WHEN pergunta LIKE '%capital do Japão%' THEN 'Geografia'
       WHEN pergunta LIKE '%país com a maior área territorial do mundo%' THEN 'Mundo'
       WHEN pergunta LIKE '%cidade mais populosa do mundo%' THEN 'Mundo'
       WHEN pergunta LIKE '%religião mais praticada no mundo%' THEN 'Mundo'
       WHEN pergunta LIKE '%cientista alemão que desenvolveu a teoria da relatividade%' THEN 'Ciência e Tecnológia'
       WHEN pergunta LIKE '%ano ocorreu a Revolução Francesa%' THEN 'Sociedade'
       WHEN pergunta LIKE '%esporte que utiliza uma bola e tacos e é popular em países como Estados Unidos e Japão%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%maior jogador de basquete de todos os tempos%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%esporte nacional do Japão%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%primeira missão tripulada a pisar na Lua%' THEN 'Ciência e Tecnológia'
       WHEN pergunta LIKE '%planeta mais próximo do Sol%' THEN 'Ciências e Tecnologia'
       WHEN pergunta LIKE '%pai da eletricidade%' THEN 'Ciência e Tecnológia'
       WHEN pergunta LIKE '%quadro famoso de Leonardo da Vinci que retrata uma mulher com um sorriso enigmático%' THEN 'Arte e Entretenimento'
       WHEN pergunta LIKE '%peça de teatro "Romeu e Julieta"%' THEN 'Arte e Entretenimento'
       WHEN pergunta LIKE '%animal símbolo do WWF (World Wide Fund for Nature)%' THEN 'Ciência e Tecnológia'
       WHEN pergunta LIKE '%capital do Japão%' THEN 'Sociedade'
       WHEN pergunta LIKE '%país com a maior área territorial do mundo%' THEN 'Mundo'
       WHEN pergunta LIKE '%cidade mais populosa do mundo%' THEN 'Mundo'
       WHEN pergunta LIKE '%cientista alemão que desenvolveu a teoria da relatividade%' THEN 'Ciência e Tecnológia'
       WHEN pergunta LIKE '%ano ocorreu a Revolução Francesa%' THEN 'Sociedade'
       WHEN pergunta LIKE '%esporte que utiliza uma bola e tacos e é popular em países como Estados Unidos e Japão%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%nome do troféu dado ao campeão da Copa do Mundo de Futebol%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%unidade de medida de energia no sistema internacional%' THEN 'Ciência e Tecnológia'
       WHEN pergunta LIKE '%nome do famoso quadro de Edvard Munch que retrata uma figura gritando%' THEN 'Arte e Entretenimento'
       WHEN pergunta LIKE '%esporte que tem uma rede, uma bola e é praticado na areia%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%troféu dado ao vencedor do Campeonato Mundial de Fórmula 1%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%esporte que utiliza uma bola pequena chamada de "pelota" e é popular na Espanha%' THEN 'Esporte e Lazer'
	   WHEN pergunta LIKE '%torneio anual de golfe que é um dos quatro torneios principais%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%nome da substância que dá a cor verde às plantas%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%instrumento usado para medir a pressão arterial%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%documento que garante a proteção de um invento ou processo inovador%' THEN 'Mundo'
	   WHEN pergunta LIKE '%capital da Espanha%' THEN 'Sociedade'
	   WHEN pergunta LIKE '%líder político responsável pela unificação da Alemanha em 1871%' THEN 'Sociedade'
	   WHEN pergunta LIKE '%documento que protege os direitos fundamentais dos cidadãos em um país%' THEN 'Mundo'
	   WHEN pergunta LIKE '%esporte que tem uma bola pequena chamada de "jack" e é jogado em uma quadra de grama%' THEN 'Esporte e Lazer'
	   WHEN pergunta LIKE '%recorde de mais títulos de Wimbledon no tênis masculino%' THEN 'Esporte e Lazer'
	   WHEN pergunta LIKE '%esporte que tem uma rede, uma bola e é praticado na areia%' THEN 'Esporte e Lazer'
       WHEN pergunta LIKE '%troféu dado ao campeão da Copa do Mundo de Futebol%' THEN 'Esporte e Lazer'
	   WHEN pergunta LIKE '%unidade de medida de energia no sistema internacional%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%nome do famoso quadro de Edvard Munch que retrata uma figura gritando%' THEN 'Arte e Entretenimento'
	   WHEN pergunta LIKE '%esporte que tem uma rede, uma bola e é praticado na areia%' THEN 'Esporte e Lazer'
	   WHEN pergunta LIKE '%torneio anual de golfe que é um dos quatro torneios principais%' THEN 'Esporte e Lazer'
	   WHEN pergunta LIKE '%substância que dá a cor verde às plantas%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%instrumento usado para medir a pressão arterial%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%documento que garante a proteção de um invento ou processo inovador%' THEN 'Mundo'
	   WHEN pergunta LIKE '%capital da Espanha%' THEN 'Sociedade'
	   WHEN pergunta LIKE '%líder político responsável pela unificação da Alemanha em 1871%' THEN 'Sociedade'
	   WHEN pergunta LIKE '%documento que protege os direitos fundamentais dos cidadãos em um país%' THEN 'Mundo'
	   WHEN pergunta LIKE '%período de tempo durante o qual uma pessoa governa um país%' THEN 'Sociedade'
	   WHEN pergunta LIKE '%esporte que tem uma bola e é praticado em uma quadra dividida por uma rede%' THEN 'Esporte e Lazer'
	   WHEN pergunta LIKE '%evento esportivo internacional que ocorre a cada quatro anos e reúne atletas de todo o mundo%' THEN 'Esporte e Lazer'
	   WHEN pergunta LIKE '%pai da teoria da evolução das espécies por seleção natural%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%unidade de medida de temperatura no sistema internacional%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%nome do processo pelo qual os organismos vivos produzem energia%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%unidade básica de armazenamento em um computador%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%pai da teoria da relatividade%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%capacidade de um material conduzir eletricidade%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%componente químico principal do vidro%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%processo que converte açúcar em álcool e dióxido de carbono%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%instrumento utilizado para visualizar objetos distantes no céu%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%autor da obra "A Divina Comédia"%' THEN 'Arte e Entretenimento'
	   WHEN pergunta LIKE '%pintor impressionista que pintou "Impressão, nascer do sol"%' THEN 'Arte e Entretenimento'
	   WHEN pergunta LIKE '%atriz que interpretou Katniss Everdeen nos filmes da série "Jogos Vorazes"%' THEN 'Arte e Entretenimento'
	   WHEN pergunta LIKE '%diretor do filme "Titanic"%' THEN 'Arte e Entretenimento'
	   WHEN pergunta LIKE '%famoso prêmio de cinema concedido pela Academia de Artes e Ciências Cinematográficas%' THEN 'Arte e Entretenimento'
	   WHEN pergunta LIKE '%famoso evento de tecnologia realizado anualmente em Las Vegas%' THEN 'Ciência e Tecnológia'
	   WHEN pergunta LIKE '%famosa avenida de Londres conhecida por seus teatros e cinemas%' THEN 'Mundo'
	END
) WHERE id > 0;
